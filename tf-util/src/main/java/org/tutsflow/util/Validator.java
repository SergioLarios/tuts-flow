...
import org.tutsflow.constant.CharPool;
...
public class Validator {
	...
	public static boolean isDomain(String domainName) {
		...
		String[] domainNameArray = StringUtils.split(
	...
	public static boolean isPhoneNumber(String phoneNumber) {
		return isNumber(_extractDigits(phoneNumber));
	}
	 ...
	 *         string
	 */
	private static String _extractDigits(String s) {
		if (s == null) {
